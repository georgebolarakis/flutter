...
class _MyAppState extends State<MyApp> {
  ...
  void initState() {
    ...
    //title album 1 lorem ipsum
    futureAlbum = fetchAlbum();
    //textfiled #id --> Deleted http 200
    //null ?? 'deleted'
  }
                ...
                return Column(
                  ...
                  children: <Widget>[
                    ...
                    TextField(
                      ...
                      decoration: const InputDecoration(hintText: 'Album Id to delete'),
                    ),
                    ElevatedButton(
                        onPressed: () {
                          setState(() {
                        ...
                        child: const Text('confirm delete data'))
                  ],
                );
